...
## -----------------------------------------------------------------------------
## Goal: Create a YOLOv3 pre-trained model and save it as a Keras model for later use.
## -----------------------------------------------------------------------------
## Command line arguments:
## 1) -w     :weights parameter
##            pre-trained darknet model weights file location
## 2) -smp   :saved model parameter
##            Where the output Keras model should be saved
## -----------------------------------------------------------------------------
## Usage example:
...
argparser.add_argument(
    '-smp',
    '--savemodelpath',
    help='path to where keras model to be saved')
...
def _main_(args):
    ...
    weights_path = args.weights              # -w   parameter, the pre-trained models weigth file
    model_save_path = args.savemodelpath     # -smp parameter, the location to where the model should be saved
    ...
    # save the model
    #model_save_path      = r"mymodel.saved"
    yolov3.save(model_save_path)
    print(f"\nYolov3 model saved to: {model_save_path}\n")
